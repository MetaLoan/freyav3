...
import { Pressable, ScrollView as RNScrollView, ImageBackground, Image as RNImage } from 'react-native';
...
function CosmicEventCard({
  ...
  return (
    <AppCard variant="default" padding="md" pressable>
      <YStack width={s(140)} space={spacing.sm}>
      ...
      <YStack>
        ...
        <YStack>
          <YStack 
            ...
            overflow="hidden"
            // @ts-ignore
            style={{ boxShadow: 'inset 0 1px 0 0 rgba(196, 154, 108, 0.05)' }}
          >
            {/* 背景图片层 */}
            <ImageBackground
            ...
            >
              ...
              <YStack flex={1} backgroundColor="transparent" position="relative">
                ...
                <YStack 
                  ...
                  paddingBottom={layout.card.paddingLg}
                  space={spacing.lg}
                >
                  {/* 1. 头像 */}
                  ...
                  >
                    <Text fontFamily="$heading" fontSize={fs(14)} fontWeight="600" color={palette.gold50}>
                      Ask Freya
                    </Text>
                  </Pressable>
                </YStack>
          ...
          >
            ...
            >
              <DimensionCard
                ...
                value={82}
                color={palette.gold200}
                totemImage={dimensionSpirit}
              />
            </YStack>

            {/* Mind - 皇家蓝渐变（上部高亮，下部阴影） */}
            <YStack
              width={s(120)}
              height={s(140)}
              borderRadius={s(20)}
            ...
            >
              <DimensionCard
                ...
                value={65}
                color={palette.gold200}
                totemImage={dimensionMind}
              />
            </YStack>

            {/* Body - 珊瑚橙渐变（上部高亮，下部阴影） */}
            <YStack
              width={s(120)}
              height={s(140)}
              borderRadius={s(20)}
            ...
            >
              <DimensionCard
                ...
                value={91}
                color={palette.gold200}
                totemImage={dimensionBody}
              />
            </YStack>

            {/* Emotion - 紫色渐变（上部高亮，下部阴影） */}
            <YStack
              width={s(120)}
              height={s(140)}
              borderRadius={s(20)}
            ...
            >
              <DimensionCard
                ...
                value={74}
                color={palette.gold200}
                totemImage={dimensionEmotion}
              />
            </YStack>

            {/* Social - 绿色渐变（上部高亮，下部阴影） */}
            <YStack
              width={s(120)}
              height={s(140)}
              borderRadius={s(20)}
        ...
        <YStack marginTop={layout.page.sectionGap}>
          ...
          >
            <CosmicEventCard
              ...
              description="Communication may face challenges"
            />
            <CosmicEventCard
              ...
              description="Emotions heightened, time for release"
            />
            <CosmicEventCard
              name="Venus in Pisces"
              timeLeft="ends 12d"
              icon={Heart}
              color={palette.royal400}
              description="Romance and creativity flourish"
            />
            <CosmicEventCard
              name="Mars in Cancer"
              timeLeft="ends 28d"
              icon={Flame}
              color="#4CAF7D"
              description="Nurturing energy, protect what matters"
            />
          </ScrollView>
        </YStack>

        {/* ===== Ask a Consultant ===== */}
        <YStack paddingHorizontal={layout.page.paddingH} marginTop={layout.page.sectionGap}>
